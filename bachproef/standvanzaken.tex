...
\section{Ansible}
Ansible is een open source IT configuration management en deployment tool. In deze Ansible hun grote doel is om besturingssysteem configuratie en de implementatie van software allemaal onder 1 systeem. De informatie werd gevonden met behulp van het document \textit{Ansible In Depth} \autocite{ansibleid}.
...
Ansible is zeer makkelijk te deployen cloud omgevingen als publieke of private cloud omgeving op cloud providers als Amazon Web Services, Microsoft Azure, Rackspace,... Maar ook op lokale infrastructuren zoals Virtualbox, VMware,... Hier toe behoort niet alleen compute provision, maar ook opslag en netwerken.
